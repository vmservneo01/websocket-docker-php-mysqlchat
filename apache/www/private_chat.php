...
<html>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var conn = new WebSocket('wss://websockchat.ru/ws/?token=<?php echo $token; ?>'); // Create the Browser Web API WebSocket object i.e. Start the WebSocket connection!    // Initiate/Start the WebSocket connection in the browser. Check the browser's console.
